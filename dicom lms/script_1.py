...
with open("medical-imaging-lms/docker-compose.yml", "w") as f:
    f.write(docker_compose_content)

# Create environment variables template
env_content = """# Medical Imaging LMS Environment Variables
...
# Moodle
MOODLE_ADMIN_PASSWORD=your_secure_admin_password_here
...
# SSL Certificates
SSL_CERT_PATH=./configs/ssl/fullchain.pem
SSL_KEY_PATH=./configs/ssl/privkey.pem
...
with open("medical-imaging-lms/.env.template", "w") as f:
    f.write(env_content)

print("✅ Created Docker Compose configuration")
print("✅ Created environment variables template")
print("\n📋 Main services configured:")
print("- Moodle LMS (Port 80/443)")
print("- PostgreSQL Database")
print("- Orthanc DICOM Server (Port 8042)")
print("- OHIF Viewer (Port 3000)")
print("- Pathology Viewer (Port 8080)")
print("- Unified Medical Viewer (Port 3001)")
